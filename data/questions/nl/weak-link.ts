...
export const weakLinkQuestions: WeakLinkQuestion[] = [
...

  {
    ...
    content: article('wl-d2-2', {
      ...
      headline: 'RIVM: kraanwater in delen van Noord-Brabant tijdelijk onveilig',
