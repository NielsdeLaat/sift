...
export const whenOrWhereQuestions: WhenOrWhereQuestion[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    text: "Foto van wateroverlast in de buurt van Tiel, afgelopen augustus.",
    options: [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    text: "Demonstranten trekken door het centrum richting het Binnenhof in Den Haag.",
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    text: "Foto gemaakt op 3 januari bij het begin van de overstroming langs de Waal bij Nijmegen.",
    options: [
