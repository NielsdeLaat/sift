...
export const nameTrickQuestions: NameTrickQuestion[] = [
...

  {
    ...
    correctIndex: 0,
    explanation:
      "Dit bericht maakt je bang met hoofdletters, uitroeptekens en een anoniem verhaal over een buurvrouw — maar zonder officiële recall, naam of bron. Angst vervangt hier het bewijs.",
  },

  {
    ...
    correctIndex: 1,
    explanation:
      "De post noemt een 'oud-medewerker van ProRail' maar geeft geen naam, functie of bewijs, dus je kunt niet controleren of die persoon bestaat of dit gezegd heeft. Een onbekende expert is geen bewijs.",
  },

  {
    ...
    correctIndex: 2,
    explanation:
      "Wachtlijsten hebben complexe oorzaken — personeelstekort, vergrijzing, budgetten — maar de post legt alles in één zin bij één groep. Zo werkt schuldaanwijzing: een ingewikkeld probleem krijgt een makkelijk doelwit.",
  },

  {
    ...
    correctIndex: 3,
    explanation:
      "De post noemt twee extreme opties als de enige keuzes, terwijl er meer mogelijkheden zijn: huurtoeslag, sociale huur, gedeeld eigendom of verhuizen naar een andere regio. Door alternatieven weg te laten, ontstaat een vals gevoel van hopeloosheid.",
  },
...

  {
    ...
    correctIndex: 0,
    explanation:
      "De post stelt alleen vragen en trekt nooit een conclusie, maar de vragen samen suggereren opzet en bedrog. Door nooit iets te beweren hoeft de schrijver niets te bewijzen — de lezer trekt de conclusie zelf.",
  },

  {
    ...
    content: social("nt-d2-2", {
      ...
      text: "Gisteren werden studenten van begin twintig hardhandig van straat gesleurd terwijl ze vredig demonstreerden voor hun toekomst. Ze kregen traangas in het gezicht. Gewone jongeren die niets anders deden dan schreeuwen dat ze willen overleven. Kun je je voorstellen hoe bang ze waren? Dit raakt me tot in mijn hart. Deel dit als jij ook verontwaardigd bent.",
    }),
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Het bericht gebruikt indringende details om verontwaardiging op te wekken, maar noemt geen bron, rapport of naam. De emotionele kracht van het verhaal is bedoeld om verificatie overbodig te laten lijken.",
  },

  {
    ...
    correctIndex: 2,
    explanation:
      "De post citeert een 'voormalig directeur' die anoniem blijft, dus je kunt zijn identiteit, functie en het cijfer van 40% niet controleren. Hoe specifieker een anonieme bron klinkt, hoe geloofwaardiger hij lijkt — maar anoniem blijft anoniem.",
  },

  {
    ...
    correctIndex: 3,
    explanation:
      "De post presenteert twee opties alsof er geen alternatieven zijn: direct ingrijpen of mensen sterven, terwijl er meer wegen zijn zoals noodvoorraden, Europese inkoop of tijdelijke regelingen. Het vals dilemma creëert kunstmatige urgentie.",
  },
...

  {
    ...
    correctIndex: 1,
    explanation:
      "De post verbindt uiteenlopende problemen — energie, voedsel, wonen, stikstof — aan één oorzaak: het klimaatbeleid, terwijl elk probleem zijn eigen oorzaken en context heeft. Als alles wordt teruggebracht tot dezelfde agenda zonder bewijs per probleem, is dat scapegoating.",
  },

  {
    ...
    content: social("nt-d3-2", {
      ...
      text: "Het woningtekort staat officieel op 400.000 huizen. Maar wie houdt die statistieken bij? Het CBS — dat rapporteert aan dezelfde overheid die het beleid heeft bepaald. Hoe is het mogelijk dat een land dat twintig jaar geleden nog bouwoverschotten kende, nu ineens een half miljoen huizen tekort heeft? Is het toeval dat dit tekort samenvalt met de jaren waarin de overheid zelf de woningbouw stillegde? Ik zeg niet dat er opzet in het spel is. Maar waarom worden die vragen niet gesteld in de Tweede Kamer? Wat heeft de overheid hier te verbergen?",
    }),
    options: [
    ...
    correctIndex: 4,
    explanation:
      "De post stelt zes retorische vragen maar maakt nooit een directe claim, zodat elke suggestie — het CBS is niet onafhankelijk, de overheid verbergt iets — blijft hangen zonder bewijs. Het slot 'wat heeft de overheid te verbergen?' is een beschuldiging verpakt als vraag.",
  },

  {
    ...
    correctIndex: 0,
    explanation:
      "Het bericht vertelt een indringend, gedetailleerd persoonlijk verhaal, maar er zijn geen officiële wachtlijstcijfers, geen naam en geen medische bron. Het verhaal is oprecht bedoeld, maar de emotionele kracht vervangt hier de verificatie.",
  },

  {
    ...
    correctIndex: 2,
    explanation:
      "'Dr. Pieter Klaassens' klinkt gezaghebbend met zijn titel, functie en concrete cijfers, maar je kunt zijn rapport, achtergrond en instituut nergens terugvinden. Hoe concreter een expert klinkt, hoe geloofwaardiger hij lijkt — maar dat maakt hem nog niet verifieerbaar.",
  },
];
