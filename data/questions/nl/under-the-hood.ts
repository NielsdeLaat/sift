...
export const underTheHoodQuestions: UnderTheHoodQuestion[] = [
...

  {
    ...
    items: [
      ...
      { label: 'GPS-locatie', value: '51.9244 N, 4.4777 E (Rotterdam, Nederland)' },
      { label: 'Omgekeerd zoeken', value: 'Geen eerdere afbeeldingen gevonden' },
    ],
    correctFlagIndex: 2,
    explanation:
...

  {
    ...
    items: [
      ...
      { label: 'GPS-locatie', value: '52.2640 N, 6.7935 E (Hengelo, Overijssel)' },
      { label: 'Bewerkingssoftware', value: 'Geen bewerkingssoftware gedetecteerd' },
      { label: 'Omgekeerd zoeken', value: 'Geen eerdere afbeeldingen gevonden' },
    ],
    correctFlagIndex: 3,
    explanation:
...

  {
    ...
    xp: 80,
    difficulty: 2,
    content: social('uth-d2-2', {
      avatarUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=omwonenden_ijmuiden',
    ...
    items: [
      ...
      { label: 'GPS-locatie', value: '52.4488 N, 4.6267 E (IJmuiden, Nederland)' },
...

  {
    ...
    xp: 90,
    difficulty: 3,
    content: social('uth-d3-1', {
      avatarUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=nijmegen_live',
    ...
    items: [
      ...
      { label: 'GPS-locatie', value: '51.8583 N, 5.8627 E (Nijmegen, Nederland)' },
      { label: 'Bewerkingssoftware', value: 'Geen bewerkingssoftware gedetecteerd' },
      { label: 'Omgekeerd zoeken', value: 'Geen eerdere afbeeldingen gevonden' },
    ],
    correctFlagIndex: 2,
...

  {
    ...
    items: [
      ...
      { label: 'GPS-locatie', value: '52.0799 N, 4.3113 E (Den Haag, Nederland)' },
      { label: 'Bewerkingssoftware', value: 'Adobe Lightroom Classic 13.0' },
      {
        label: 'Omgekeerd zoeken',
        value: 'Afbeelding gevonden op 1 site; vroegste: gettyimages.nl, gepubliceerd 2025-03-04',
      },
    ],
    correctFlagIndex: 5,
    explanation:
